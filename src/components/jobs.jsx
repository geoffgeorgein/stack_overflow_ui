    ...
    <div>
      ...
      <div className="bottomSec pt-4 mt-10">
        ...
        <ul className="text-cyan-600">
          ...
          <li className="py-3">
            {" "}
            Why does everybody typedef over standard type C types
          </li>
          <li className="py-3"> An Englisg word describing apseudo job</li>
          <li className="py-3">
            {" "}
            When flying on a very tight schedule where u obligedto run to make
            it to the next gate connection
          </li>
        </ul>
      </div>
    </div>
